...
下载 [2.0.9 发行版](https://github.com/noah-ad/MD-Card-Mod-Tool/releases/tag/v2.0.9)。解压后根目录只有 `MD卡图查看替换器.exe` 与 `data` 文件夹，直接运行 EXE 即可；若文件带有 Windows 下载标记，可先运行 `data\首次启动-解除下载封锁.bat`。
